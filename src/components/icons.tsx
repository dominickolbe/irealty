...
// New property-related icons
export function SquareMeterIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export function VillaIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export function TerrainIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
...
export function EuroIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path d="M6 12h12" />
      <path d="M6 12c0-3.314 2.686-6 6-6 1.931 0 3.643.913 4.728 2.318" />
      <path d="M6 12c0 3.314 2.686 6 6 6 1.931 0 3.643-.913 4.728-2.318" />
    </svg>
  );
}
